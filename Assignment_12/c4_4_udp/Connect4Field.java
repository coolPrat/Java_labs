...
public class Connect4Field implements Connect4FieldInterface {
    ...
    private PlayerInterface[] thePlayers = new PlayerInterface[4];
    ...
    public void init(PlayerInterface playerA, PlayerInterface playerB, PlayerInterface playerC, PlayerInterface playerD) {
        this.thePlayers[0] = playerA;
        this.thePlayers[1] = playerB;
        this.thePlayers[2] = playerC;
        this.thePlayers[3] = playerD;
    }
