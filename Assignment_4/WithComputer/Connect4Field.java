...
public class Connect4Field implements Connect4FieldInterface {
     ...
     */
    public void setPiecesForWinning(int piecesForWinning) {
     ...
     */
    public PlayerInterface[] getThePlayers() {
        return thePlayers;
    }
     ...
     */
    public int getPiecesForWinning() {
     ...
     */
    public String getWinningPattern(char gamePiece, int piecesForWinning) {
        String pattern = "";
    ...
    /**
     * This is the main method to play the game. It takes user input which tells
     * in which column user wishes to drop the game-piece. It checks for the
     * winning pattern and ends the game if its a draw or a player wins.
     */
    @Override
        ...
        while (gameIsOn) {
            ...
            if (checkIfPiecedCanBeDroppedIn(column)) {
                ...
                if (didLastMoveWin()) {
                    gameIsOn = false;
                    System.out.println(this);
                    System.out.println(thePlayers[index].getName() + " won!");
                } else if (isItaDraw()) {
                    gameIsOn = false;
                    System.out.println(this);
                ...
                System.out.println("Can not add... Sorry");
            }
        }
    }
     ...
     * @return    String that represents current state of the game
     */
